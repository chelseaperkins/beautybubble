            ...
            <div class="row">
                <div class="col-sm-4 col-md-4 text center">
                    ...
                    <div class="dash_appointment_cell">
                        ...
                        <div class="class-tile-menu-toggle btn-group"><a name="class_tile_dropdown" class=" dash_dropdown_btn btn btn-white dropdown-toggle img-circle" data-toggle="dropdown"><b class="caret"></b>
...
Last name: Blogs <br /></p>-->
            ...
            <div class="edit-class-modal"><div class="modal-header"><button type="button" class="close">× </button>

                    <div class="edit-class"><div class="edit-class-title"><h2>Add/Edit Appointment</h2></div>
                        <div class="edit-class-year"><p></p></div></div>
